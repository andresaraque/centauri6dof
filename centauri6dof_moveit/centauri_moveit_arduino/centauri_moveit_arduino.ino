...
#include <centauri_moveit/ArmJointState.h>
#include <Servo.h> 
...
void arm_cb(const centauri_moveit::ArmJointState& arm_steps){
  joint_status = 1;
...
ros::Subscriber<centauri_moveit::ArmJointState> arm_sub("joint_steps",arm_cb); //subscribes to joint_steps on arm
